...
import com.goprex.ui.pedido.GestaoEntregasScreen
import com.goprex.ui.theme.GoprexTheme

class tela_gestao_entregas : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            GoprexTheme {
                HeaderComMenu(loginData = loginData, titulo = "Gestão de Entregas", onLogout = {
