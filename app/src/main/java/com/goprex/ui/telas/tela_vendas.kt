...
import com.goprex.ui.pedido.VendasScreen
import com.goprex.ui.theme.GoprexTheme

class tela_vendas : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            GoprexTheme {
                HeaderComMenu(loginData = loginData, titulo = "Vendas", onLogout = {
                    ...
                    VendasScreen(loginData = loginData)
                })
            }
        }
    }
