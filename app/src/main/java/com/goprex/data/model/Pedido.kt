...
data class Pedido(
    ...
    val enderecoEntregaId: String = "",
    val enderecoEntregaApelido: String = "",
    val enderecoEntregaResumo: String = "",
    val loja: String = "",
